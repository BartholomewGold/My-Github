...
public class LineForm implements java.io.Serializable {
	...
	public LineForm(String[] producters, String model, Double volt,
	...
	public Object[] getSQL() {
		...
		String hql = "select a.scdw,a.qyrq,AVG(CONVERT(real,b.[avg])) as avgs from ls_jb_cs a,T_AvgScore b "
				+ "where a.cdid=b.cdid ";
