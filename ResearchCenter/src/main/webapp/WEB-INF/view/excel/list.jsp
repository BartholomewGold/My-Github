...
<body>
	<div class="wrap">
		<div class="path">
			当前路径：<a href="#">后台首页</a> - EXCEL导出
			<div class="back">
				<a href="javascript:history.back();"><i>»</i>返回上一层</a>
			</div>
		</div>
		<div class="box1">
			<div class="box1_t">EXCEL导出</div>
			<div class="box1_c">
				<form id="mainForm" action="/ResearchCenter/excel/getNormalexcel" method="post">
					...
					<div class="box1_btn">
						<input id="commit" type="button" class="btn_search btn1"
							...
							id="excel" type="button" class="btn_search btn" value="导出excel" />
					</div>
				</form>
